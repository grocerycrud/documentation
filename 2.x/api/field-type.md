...
<pre><code class="php">fieldType(string $fieldName, string $fieldType[, array $permittedValues[, array $options]])</code></pre>
...
<pre><code class="php">$crud->fieldType('website_url', GroceryCrud::FIELD_TYPE_URL);</code></pre>

or:

<pre><code class="php">$crud->fieldType('website_url', 'url');</code></pre>
...
<pre><code class="php">'string' //default
'text' 
'date'
'enum'
'enum_searchable'
...
<pre><code class="php">$crud->fieldType('total_distance', 'float');</code></pre>


<h3 id="dropdown_search">dropdown_search</h3>
A dropdown list that it is also searchable.

<pre><code class="php">// Example by referring to a database id (e.g.12,13, 14... e.t.c.)
...
<pre><code class="php">// Example by adding the actual value
$crud->fieldType('contact_title', 'dropdown_search', [
    'Master' => 'Master',
    'Mr' => 'Mr',
    'Miss' => 'Miss',
...
<pre><code class="php">$crud->fieldType('gift_category', 'multiselect_native', [
    'baby' => 'Baby',
    'beauty' => 'Beauty',
    'stripbooks' => 'Books',
...
<pre><code class="php">$crud->fieldType('gift_category', 'multiselect_searchable', [
    'baby' => 'Baby',
    'beauty' => 'Beauty',
    'stripbooks' => 'Books',
    'automotive' => 'Car & Motorbike',
...
<pre><code class="php">$crud->setRelation('officeCode', 'offices', 'city');
