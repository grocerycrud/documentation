...
Go to <code>app/Views</code> and create a file with name <code>example.php</code> and it is the exact same view that we were using as an example at Free edition. More specifically the view <em>example.php</em> will contain the below code:
